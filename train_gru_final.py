...
# Must pass to exec's globals explicitly
_globals = globals()
_globals['__SKIP_MAIN__'] = True

# 🔥 ИСПРАВЛЕНИЕ: Windows encoding issue
exec(open('examples/gru_training_pytorch_v2_percentage.py', encoding='utf-8').read(), _globals)
